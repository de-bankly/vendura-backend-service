...
public class ProductTransactionControllerV1 {
    ...
    public ResponseEntity<Page<ProductTransactionDTO>> getTransactionsByProductId(
        ...
        productRepository.findById(productId)
                .orElseThrow(() -> new EntityRetrieveException(
                        "Product not found", HttpStatus.NOT_FOUND, productId));
        
        // Get transactions
        Page<ProductTransactionDTO> transactions = productTransactionService
